    ...
    return(
      <div className={styles.statementContainer}>
        ...
        <div className={styles.copyContainer}>
          ...
          <p>
            Inaction is one thing, but Trump also fired the US Pandemic Response Team in 2018,<span>2</span> willfully ignored the NSC’s pandemic response playbook,<span>3</span> fired CDC experts in China,<span>4</span> haphazardly downplayed the severity of the pandemic 
            for weeks,<span>5</span> is cutting funding to the vital World Health Organization,<span>6</span> and is using his press conferences to tout scientifically unproven and potentially dangerous drugs as treatments for the Coronavirus.<span>7</span>
          </p>
          <p>
